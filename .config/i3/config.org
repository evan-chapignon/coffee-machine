...
#+BEGIN_SRC conf
exec_always --no-startup-id feh --bg-scale /usr/share/backgrounds/gnome/blobs-l.svg
...
exec_always --no-startup-id sh -c "sleep 0.3 && setxkbmap fr -option ctrl:nocaps"
exec xinput set-prop "ELAN06A0:00 04F3:3231 Touchpad" "libinput Natural Scrolling Enabled" 1
#+END_SRC
